...
{
    public partial class rolesrobertoContext : DbContext
    {
        public rolesrobertoContext()
        {
        }

        public rolesrobertoContext(DbContextOptions<rolesrobertoContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user=root;password=root;database=rolesroberto", x => x.ServerVersion("8.0.17-mysql"));
            }
        }
